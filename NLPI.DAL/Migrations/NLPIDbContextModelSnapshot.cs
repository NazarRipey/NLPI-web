...
namespace NLPI.DAL.Migrations
{
    ...
    partial class NLPIDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NLPI.Core.Models.AchievementData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NLPI.Core.Models.Level", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("NLPI.Core.Models.LevelResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("NLPI.Core.Models.Metadata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("NLPI.Core.Models.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("NLPI.Core.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("NLPI.Core.Models.TagDistribution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("NLPI.Core.Models.TaskDistribution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.Property<int?>("IdLevelNavigationId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("IdLevelNavigationId");
            ...
            modelBuilder.Entity("NLPI.Core.Models.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("NLPI.Core.Models.UserAchievement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("NLPI.Core.Models.AchievementData", b =>
                {
                    b.HasOne("NLPI.Core.Models.UserAchievement", "IdUserAchievementNavigation")
            ...
            modelBuilder.Entity("NLPI.Core.Models.LevelResult", b =>
                {
                    b.HasOne("NLPI.Core.Models.Level", "Level")
                        .WithMany()
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NLPI.Core.Models.User", "User")
            ...
            modelBuilder.Entity("NLPI.Core.Models.Metadata", b =>
                {
                    b.HasOne("NLPI.Core.Models.Unit", "IdUnitNavigation")
                        .WithMany("Metadatas")
            ...
            modelBuilder.Entity("NLPI.Core.Models.TagDistribution", b =>
                {
                    b.HasOne("NLPI.Core.Models.Metadata", "IdMetadataNavigation")
                    ...
                    b.HasOne("NLPI.Core.Models.Tag", "IdTagNavigation")
                        .WithMany("TagDistributions")
                        .HasForeignKey("IdTag")
            ...
            modelBuilder.Entity("NLPI.Core.Models.TaskDistribution", b =>
                {
                    b.HasOne("NLPI.Core.Models.Level", "IdLevelNavigation")
                        .WithMany()
                        .HasForeignKey("IdLevelNavigationId");
            ...
            modelBuilder.Entity("NLPI.Core.Models.TestTask", b =>
                {
                    ...
                    b.HasOne("NLPI.Core.Models.Metadata", null)
                        .WithMany("Tasks")
                        .HasForeignKey("MetadataId");

                    b.HasOne("NLPI.Core.Models.Question", null)
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("NLPI.Core.Models.UserAchievement", b =>
                {
                    ...
                    b.HasOne("NLPI.Core.Models.User", "IdUserNavigation")
